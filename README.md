...
[▶ 观看认知模型演示片段（1:55）](docs/video/chapters/cognitive-model.mp4)
...
[▶ 观看 Evolve 演示片段（1:55）](docs/video/chapters/evolve.mp4)
...
[▶ 观看浏览与搜索演示片段（0:55）](docs/video/chapters/browse-search.mp4)
...
[▶ 观看洞察演示片段（0:50）](docs/video/chapters/insights.mp4)
